...
func TestCreateTrip(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:       "finished",
			tripID:     "5f81323eb00714bf62948905c",
			accountID:  "account1",
			tripStatus: rentalpb.TripStatus_FINISHED,
		},
		{
			name:       "another_finished",
			tripID:     "5f81323eb00714bf62948905d",
			accountID:  "account1",
			tripStatus: rentalpb.TripStatus_FINISHED,
		},
		{
			name:       "in_progress",
			tripID:     "5f81323eb00714bf62948905e",
			accountID:  "account1",
			tripStatus: rentalpb.TripStatus_IN_PROGRESS,
		},
		{
			name:       "another_in_progress",
			tripID:     "5f81323eb00714bf62948905f",
			accountID:  "account1",
			tripStatus: rentalpb.TripStatus_IN_PROGRESS,
			wantErr:    true,
		},
		{
			...
			tripID:     "5f81323eb00714bf629489060",
			accountID:  "account2",
			tripStatus: rentalpb.TripStatus_IN_PROGRESS,
		},
	}
...
func TestUpdateTrip(t *testing.T) {
	...
	cases := []struct {
		...
		{
			name:          "update_with_stale_stimestamp",
			now:           30000,
			withUpdatedAt: 10000,
			wantErr:       true,
		},
	...
	for _, cc := range cases {
		...
		if now != updatedTrip.UpdateAt {
			t.Errorf("%s: incorrect updatedat: want %d, got %d", cc.name, now, updatedTrip.UpdateAt)
		}
	}
}
