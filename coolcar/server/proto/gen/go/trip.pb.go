...
type Trip struct {
	...
	Start         string      `protobuf:"bytes,1,opt,name=start,proto3" json:"start,omitempty"`                                 // 第一个字段是 start  因为是二进制流 所以需要告诉
	End           string      `protobuf:"bytes,2,opt,name=end,proto3" json:"end,omitempty"`                                     // 第二个字段是 end
	DurationSec   int64       `protobuf:"varint,3,opt,name=duration_sec,json=durationSec,proto3" json:"duration_sec,omitempty"` // 命名养成好的习惯，把单位放进去
	...
	PathLocations []*Location `protobuf:"bytes,7,rep,name=path_locations,json=pathLocations,proto3" json:"path_locations,omitempty"` // repeated 字段一般命名使用复数形式
