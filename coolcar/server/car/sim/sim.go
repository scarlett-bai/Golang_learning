...
func (c *Controller) SimulateCar(ctx context.Context, inital *carpb.CarEntity, carCh chan *carpb.Car, posCh chan *carpb.Location) {
	car := inital
...
func (c *Controller) lockCar(ctx context.Context, car *carpb.CarEntity) (*carpb.CarEntity, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("cannot simulate car position:")
	}
	return car, nil
}
...
func (c *Controller) unlockCar(ctx context.Context, car *carpb.CarEntity) (*carpb.CarEntity, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("cannot simulate car positon: %v", err)
	}
	return car, nil
}
